...
export const productScenes: Record<string, () => Promise<any>> = {
  ...
  SupportTickets: () =>
    import("../../products/conversations/frontend/scenes/tickets/SupportTicketsScene"),
  SupportTicketDetail: () =>
    import("../../products/conversations/frontend/scenes/ticket/SupportTicketScene"),
  SupportSettings: () =>
    import("../../products/conversations/frontend/scenes/settings/SupportSettingsScene"),
  CustomerAnalytics: () =>
    import("../../products/customer_analytics/frontend/CustomerAnalyticsScene"),
  ...
  EarlyAccessFeatures: () =>
    import("../../products/early_access_features/frontend/EarlyAccessFeatures"),
  EarlyAccessFeature: () =>
    import("../../products/early_access_features/frontend/EarlyAccessFeature"),
  ...
  ErrorTracking: () =>
    import("../../products/error_tracking/frontend/scenes/ErrorTrackingScene/ErrorTrackingScene"),
  ErrorTrackingIssue: () =>
  ...
  FeatureFlagTemplates: () =>
    import("../../products/feature_flags/frontend/FeatureFlagTemplatesScene"),
  ...
  LLMAnalyticsSession: () =>
    import("../../products/llm_analytics/frontend/LLMAnalyticsSessionScene"),
  LLMAnalyticsUsers: () => import("../../products/llm_analytics/frontend/LLMAnalyticsUsers"),
  LLMAnalyticsPlayground: () =>
    import("../../products/llm_analytics/frontend/LLMAnalyticsPlaygroundScene"),
  LLMAnalyticsDatasets: () =>
    import("../../products/llm_analytics/frontend/datasets/LLMAnalyticsDatasetsScene"),
  LLMAnalyticsDataset: () =>
    import("../../products/llm_analytics/frontend/datasets/LLMAnalyticsDatasetScene"),
  ...
  LLMAnalyticsEvaluation: () =>
    import("../../products/llm_analytics/frontend/evaluations/LLMAnalyticsEvaluation"),
  LLMAnalyticsEvaluationTemplates: () =>
    import("../../products/llm_analytics/frontend/evaluations/EvaluationTemplates"),
  LLMAnalyticsPrompts: () =>
    import("../../products/llm_analytics/frontend/prompts/LLMPromptsScene"),
  LLMAnalyticsPrompt: () => import("../../products/llm_analytics/frontend/prompts/LLMPromptScene"),
  LLMAnalyticsClusters: () =>
    import("../../products/llm_analytics/frontend/clusters/LLMAnalyticsClustersScene"),
  LLMAnalyticsCluster: () =>
    import("../../products/llm_analytics/frontend/clusters/LLMAnalyticsClusterScene"),
  ...
  SessionGroupSummariesTable: () =>
    import("../../products/session_summaries/frontend/SessionGroupSummariesTable"),
  SessionGroupSummary: () =>
    import("../../products/session_summaries/frontend/SessionGroupSummaryScene"),
  ...
  WorkflowsLibraryTemplate: () =>
    import("../../products/workflows/frontend/TemplateLibrary/MessageTemplate"),
};
...
export const productRoutes: Record<string, [string, string]> = {
  ...
  "/llm-analytics/evaluations/offline/experiments": [
    "LLMAnalyticsEvaluations",
    "llmAnalyticsOfflineEvaluations",
  ],
  "/llm-analytics/evaluations/offline/experiments/:experimentId": [
    "LLMAnalyticsEvaluations",
    "llmAnalyticsOfflineEvaluationExperiment",
  ],
  "/llm-analytics/evaluations/templates": [
    "LLMAnalyticsEvaluationTemplates",
    "llmAnalyticsEvaluationTemplates",
  ],
...
export const productConfiguration: Record<string, any> = {
  ...
  Models: {
    ...
    defaultDocsPath: "/docs/data-warehouse",
    description:
      "Create and manage views and materialized views for transforming and organizing your data.",
    iconType: "sql_editor",
  },
  SQLEditor: {
    projectBased: true,
  ...
  EarlyAccessFeatures: {
    ...
    description:
      "Allow your users to individually enable or disable features that are in public beta.",
  ...
  EndpointsScene: {
    ...
    iconType: "endpoints",
    description:
      "Define queries your application will use via the API and monitor their cost and usage.",
  },
  ...
  TaskTracker: {
    ...
    description:
      "Tasks are work that agents can do for you, like creating a pull request or fixing an issue.",
    iconType: "task",
  },
...
export const productUrls = {
  ...
  errorTrackingConfiguration: (params = {}): string =>
    combineUrl("/error_tracking/configuration", params).url,
  errorTrackingIssue: (
    id: string,
    params: {
      timestamp?: string;
  ...
  replaySettings: (sectionId?: string): string =>
    `/replay/settings${sectionId ? `?sectionId=${sectionId}` : ""}`,
...
export const fileSystemTypes = {
  ...
  revenue: {
    ...
    iconColor: [
      "var(--color-product-revenue-analytics-light)",
      "var(--color-product-revenue-analytics-dark)",
    ],
    filterKey: "revenue",
  },
...
export const getTreeItemsNew = (): FileSystemImport[] => [
  ...
  },
  {
    ...
    iconColor: [
      "var(--color-insight-user-paths-light)",
      "var(--color-user-paths-dark)",
    ] as FileSystemIconColor,
