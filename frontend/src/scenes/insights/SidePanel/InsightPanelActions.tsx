...
export function InsightPanelActions({ insightLogicProps }: { insightLogicProps: InsightLogicProps }): JSX.Element {
    ...
    const actions: Array<{ key: string; visible: boolean; button: () => JSX.Element }> = [
        {
            key: 'duplicate',
            visible: true,
            button: () => (
        ...
        {
            key: 'notebook',
            visible: !!insight.short_id,
            button: () => <SceneAddToNotebookDropdownMenu shortId={insight.short_id!} dataAttrKey={RESOURCE_TYPE} />,
        },
        {
            key: 'dashboard',
            visible: true,
        ...
        {
            key: 'subscribe',
            visible: isSavedInsight,
            button: () => <SceneSubscribeButton insight={insight} dataAttrKey={RESOURCE_TYPE} />,
        },
        {
            key: 'alerts',
            visible: isSavedInsight,
        ...
        {
            key: 'endpoint',
            visible: isSavedInsight && !!featureFlags[FEATURE_FLAGS.ENDPOINTS],
            button: () => (
        ...
        },
        {
            key: 'metalytics',
            visible: isSavedInsight,
            button: () => <SceneMetalyticsSummaryButton dataAttrKey={RESOURCE_TYPE} />,
        },
    ]
    ...
    return (
        <ScenePanelActionsSection>
            {actions
                .filter((a) => a.visible)
                .map((a) => (
                    <Fragment key={a.key}>{a.button()}</Fragment>
                ))}
        </ScenePanelActionsSection>
    )
}
