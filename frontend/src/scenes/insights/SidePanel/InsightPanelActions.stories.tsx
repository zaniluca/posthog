...
// Saved trends insight — shows subscribe, alerts, share, export, metalytics
...
// Saved HogQL data table — shows cohort button, hides SQL editor (already in SQL)
...
// Saved data visualization — shows SQL editor and cohort
...
// Unsaved insight (edit mode) — hides saved-only actions, shows share template
...
export const UnsavedInsight: Story = createInsightStory(unsavedInsight, 'edit')
